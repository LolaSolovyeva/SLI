...
def create_w2v(sentences):
    ...
    w2v_model.save("word2vecPythonShort.model")
sentences = []
for text in x_train:
...
w2v = Word2Vec.load("word2vecPythonShort.model")
...
model.add(Embedding(input_dim=vocab_size,
                    ...
                    mask_zero=True,
                    trainable=False))
model.add(tcn.TCN(return_sequences=False))
