...
def create_model(bert_model):
    ...
    output = Conv1D(128, 5, activation='relu') (output)
    output = GlobalMaxPool1D() (output)
    
    output = tf.keras.layers.Dense(30,activation='relu')(output)
...
plt.legend()
plt.savefig('BERT_TextCNN_Loss.png')