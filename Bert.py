...
encode_labels = {k: v for k, v in
                 zip(['2.0', '2.1', '2.2', '2.3', '2.4', '2.5', '2.6', '2.7', '3.0', '3.1', '3.2', '3.3', '3.4', '3.5',
                      '3.6', '3.7', '3.8', '3.9', '3.10', '3.11'], range(20))}
labels = []
...
history = model.fit([x_train, train_attention_masks_test.astype(int)], y_train, validation_split=0.2, epochs=100,
...
print(classification_report(test_y, pred_single,
                            target_names=['2.0', '2.1', '2.2', '2.3', '2.4', '2.5', '2.6', '2.7', '3.0', '3.1', '3.2',
                                          '3.3', '3.4', '3.5', '3.6', '3.7', '3.8', '3.9', '3.10', '3.11']))
model.save('BERT20.h5')
...
c = ConfusionMatrixDisplay.from_predictions(y_true=test_y, y_pred=most_probable(predicted), normalize='true',
                                            cmap=plt.cm.Blues,
                                            display_labels=['2.0', '2.1', '2.2', '2.3', '2.4', '2.5', '2.6', '2.7',
                                                            '3.0', '3.1', '3.2', '3.3', '3.4', '3.5', '3.6', '3.7',
                                                            '3.8', '3.9', '3.10', '3.11'], values_format='.2f')
